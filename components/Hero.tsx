  ...
  return (
    <div className="relative w-full h-[100vh] bg-stone-950 overflow-hidden shrink-0 flex items-center justify-center">
      ...
      <div className="absolute inset-0 animate-fade-in-up duration-1000">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-stone-950/90 z-[3] pointer-events-none"></div>
      </div>

      {/* Content Layer */}
      <div className="relative z-10 w-full max-w-7xl px-6 md:px-8 flex flex-col items-center text-center pointer-events-none">
        <div className="animate-fade-in-up mb-6 md:mb-8 pointer-events-auto" style={{ animationDelay: '100ms' }}>
        ...
        <h1 className="text-[14vw] md:text-[9vw] lg:text-[8vw] font-bold text-brand-light tracking-[-0.05em] font-jakarta mb-8 md:mb-10 leading-[0.9] md:leading-[0.85] drop-shadow-2xl animate-fade-in-up pointer-events-auto" style={{ animationDelay: '200ms' }}>
          Volto <br /> 
          <span className="text-amber-500 font-light font-serif italic pr-2 md:pr-4">Larva</span>
        </h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full max-w-4xl items-center animate-fade-in-up pointer-events-auto" style={{ animationDelay: '400ms' }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-end gap-4 md:gap-5 order-1 md:order-2 w-full">
            <a href="#booking-section" className="w-full sm:w-auto px-8 py-4 md:px-10 md:py-5 bg-brand-light text-brand-dark rounded-xl md:rounded-2xl font-bold text-sm tracking-wide hover:bg-amber-500 hover:text-white transition-all hover:scale-105 duration-500 font-jakarta shadow-2xl shadow-brand-light/10 flex items-center justify-center gap-3 touch-manipulation">
              Tisch buchen
              <MoveRight size={18} />
            </a>
            <button className="w-full sm:w-auto px-8 py-4 md:px-8 md:py-5 glass-card text-brand-light rounded-xl md:rounded-2xl font-medium text-sm tracking-wide hover:bg-brand-light/10 transition-all border border-brand-light/10 font-jakarta flex items-center justify-center gap-3 group touch-manipulation">
